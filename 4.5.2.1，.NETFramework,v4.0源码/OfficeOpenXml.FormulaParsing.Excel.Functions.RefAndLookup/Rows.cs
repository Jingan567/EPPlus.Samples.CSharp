...
public class Rows : LookupFunction
{
	public override CompileResult Execute(IEnumerable<FunctionArgument> arguments, ParsingContext context)
	{
		...
		{
			return CreateResult(valueAsRangeInfo.Address._toRow - valueAsRangeInfo.Address._fromRow + 1, DataType.Integer);
		}
		...
		if (ExcelAddressUtil.IsValidAddress(text))
		{
			...
			return CreateResult(rangeAddress.ToRow - rangeAddress.FromRow + 1, DataType.Integer);
		}
