...
internal class ZipFile : IEnumerable, IEnumerable<ZipEntry>, IDisposable
{
	...
	{
		string text = original.ToUpper(CultureInfo.InvariantCulture);
		string text2 = pattern.ToUpper(CultureInfo.InvariantCulture);
